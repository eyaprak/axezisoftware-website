...
const Service = ({ title, text, icon, bgUrl }) => {
    return (
        <div
            ...
            >
                <Image src={bgUrl} layout='fill' objectFit="cover" alt={title} />
            </div>
            <div className="px-14 py-11 flex flex-col items-center text-center">
                <Image src={`/icons/${icon}.svg`} width={80} height={80} className="group-hover:invert group-hover:brightness-0 duration:700" alt="icon" />
