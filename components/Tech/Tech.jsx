...
const Tech = () => {
    return (
        <div className="bg-[#211F3B] w-full py-24 flex items-center justify-center">
            <div className="max-w-siteWitdh w-full flex justify-between">
                <div className="flex-1">
                    ...
                    <Link href="/iletisim">
                        <a className="mt-16  bg-second padding px-4 py-6 text-white font-montserratSemibold inline-flex items-center gap-2">
                            <Image src="/icons/tech/arrow.svg" width={20} height={20} />
                            ŞİMDİ İLETİŞİME GEÇİN
                        </a>
                    </Link>
                </div>
                <div className="flex-1">
                    <Image src="/images/tech/our-technologies-bg.png" width={640} height={750} objectFit="cover" />
                </div>
            </div>
        </div>
    )
